  ...
  return (
    <>
      <div className="float-right mt-2 lg:mt-10 max-[400px]:mr-5 mr-8 sm:mr-16 md:mr-20 lg:mr-28">
        <Link to='/blog' className='px-2 sm:px-4 md:px-6 py-2 md:py-4 my-4 bg-[#31b675] text-white text-xs md:text-sm lg:text-base  hover:bg-white hover:text-[#31b675]'>
          ...
          <article className='mt-4 grid sm:grid-cols-3'>
            <div className='sm:col-span-2 max-w-[95%] m-auto'>
              ...
              <div className='mt-2 mb-4 flex justify-between items-center'>
                <span className="text-gray-500 text-sm mr-2 group-hover:text-white">{item.date}</span>
                <label className="rounded-md text-sm text-white bg-[#31b675] px-4 py-1 group-hover:text-[#31b675] group-hover:bg-white">{item.catgeory}</label>
              </div>

              <h1 className="text-3xl mt-6 font-semibold capitalize">{item.title}</h1>
              <p className="text-gray-500 text-sm my-4">{item.desc}</p>
              <p className="text-gray-500 text-sm my-4">{item.desc}</p>

              <h2 className="text-2xl mt-8 sm:mt-12 font-semibold capitalize">Two column text example</h2>

              <div className='grid grid-cols-2 gap-4 max-[300px]:grid-cols-1'>
                <p className="text-gray-500 text-sm my-4 max-[300px]:mt-1">{item.para}</p>
                <p className="text-gray-500 text-sm my-4 max-[300px]:mt-[-1rem]">{item.para}</p>
              </div>
            </div>
