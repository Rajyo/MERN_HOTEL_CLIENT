      ...
      <section className='mt-16'>
        <div className=' sm:max-w-[95%] md:max-w-[90%] m-auto px-3 md:flex-row flex flex-col'>
          ...
          <div className="mt-8 md:mt-12 ">
            ...
            <p className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipiscing elit amet consectetur.</p>
            <br />

            <h3 className="text-xl font-bold mb-2">Message us</h3>
            <span className="text-gray-500">info@exampal.com</span>
            <br />
            <span className="text-gray-500">+998 99 123 4567</span>
            <br />
