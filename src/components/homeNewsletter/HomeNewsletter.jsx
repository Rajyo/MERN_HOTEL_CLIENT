            ...
            <section className='mx-auto my-10'>
                <form className='m-6 sm:m-8 md:m-12 lg:m-28 bg-[#038c7f] text-white px-4 rounded-xl md:rounded-[30px] flex flex-col justify-center items-center py-6 md:py-24'>
                    ...
                    <div className='flex-col justify-center w-full md:flex-row flex pt-6 sm:pt-12'>
                        ...
                        />
                        <button onClick={() => {setEmail("Your email"); alert("Yet to make a Newsletter but still...")}} type='button' className='px-6 md:px-[50px] lg:px-[72px] py-2 md:py-5 bg-[#f2c641] rounded-lg md:rounded-2xl shadow-sm shadow-tertiary-light text-white font-bold text-base md:text-xl hover:scale-110 duration-300 transition-all'>
                            Subscribe
                        </button>
                    </div>
                </form>
